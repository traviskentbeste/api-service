...
public class EventServiceTest {
    ...
    void save() {
        ...
        // Arrange
        final var obj = Event.builder().name("myName1").build();
        when(repository.save(any(Event.class))).thenReturn(obj);

        // Act
        final var actual = service.create(new Event());
    ...
    void findById() {
        ...
        // Arrange
        final var obj = Optional.of(Event.builder().name("myName1").build());
        when(repository.findById(anyLong())).thenReturn((Optional<Event>) obj);
    ...
    void findAll() {
        ...
        // Arrange
        when(repository.findAll()).thenReturn(List.of(new Event(), new Event()));
    ...
    void update() {
        ...
        // Arrange
        final var obj = Event.builder().id(1L).name("myName1").build();
        final var updated = Event.builder().id(1L).name("myName1updated").build();
