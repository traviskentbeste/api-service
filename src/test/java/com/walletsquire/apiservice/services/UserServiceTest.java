...
public class UserServiceTest {
    ...
    void save() {
        ...
        // Arrange
        final var obj = User.builder().firstName("myName1").build();
        when(repository.save(any(User.class))).thenReturn(obj);
    ...
    void findById() {
        ...
        // Arrange
        final var obj = Optional.of(User.builder().firstName("myName1").build());
        when(repository.findById(anyLong())).thenReturn((Optional<User>) obj);
    ...
    void update() {
        ...
        // Arrange
        final var obj = User.builder().id(1L).firstName("myName1").build();
        final var updated = User.builder().id(1L).firstName("myName1updated").build();
