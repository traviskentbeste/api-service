...
public class AddressServiceTest {
    ...
    void save() {
        ...
        // Arrange
        final var obj = Address.builder().route("myName1").build();
        when(repository.save(any(Address.class))).thenReturn(obj);

        // Act
        final var actual = service.create(new Address());
    ...
    void findById() {
        ...
        // Arrange
        final var obj = Optional.of(Address.builder().route("myName1").build());
        when(repository.findById(anyLong())).thenReturn((Optional<Address>) obj);
    ...
    void findAll() {
        ...
        // Arrange
        when(repository.findAll()).thenReturn(List.of(new Address(), new Address()));
    ...
    void update() {
        ...
        // Arrange
        final var obj = Address.builder().id(1L).route("myName1").build();
        final var updated = Address.builder().id(1L).route("myName1updated").build();
