...
public class ActivityServiceTest {
    ...
    void save() {
        ...
        // Arrange
        final var obj = Activity.builder().name("myName1").build();
        when(repository.save(any(Activity.class))).thenReturn(obj);

        // Act
        final var actual = service.create(new Activity());
    ...
    void findById() {
        ...
        // Arrange
        final var obj = Optional.of(Activity.builder().name("myName1").build());
        when(repository.findById(anyLong())).thenReturn((Optional<Activity>) obj);
    ...
    void findAll() {
        ...
        // Arrange
        when(repository.findAll()).thenReturn(List.of(new Activity(), new Activity()));
    ...
    void update() {
        ...
        // Arrange
        final var obj = Activity.builder().id(1L).name("myName1").build();
        final var updated = Activity.builder().id(1L).name("myName1updated").build();
