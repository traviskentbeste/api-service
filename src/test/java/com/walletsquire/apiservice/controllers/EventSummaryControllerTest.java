...
@WebMvcTest( controllers = EventSummaryController.class )
@ComponentScan(basePackageClasses = EventSummaryMapper.class)
...
public class EventSummaryControllerTest {
    ...
    @Autowired
    EventSummaryMapper mapper;

    @Autowired
    EventSummaryController controller;

    String endpoint = "/api/v1" + controller.endpoint;

    // mock objects
    @MockBean
    EventSummaryService service;
    ...
    EventSummary entity1 = new EventSummary();
    EventSummary entity2 = new EventSummary();
    EventSummaryDTO entityDTO1 = new EventSummaryDTO();
    EventSummaryDTO entityDTO2 = new EventSummaryDTO();
    ...
    public void create() throws Exception {
        ...
        when(service.create(any(EventSummary.class))).thenReturn(entity1);
...
//        System.out.println("content : ->" + content + "<-");
    ...
    public void getAll() throws Exception {
        ...
        List<EventSummary> entitys = new ArrayList<>(Arrays.asList(entity1, entity2));
    ...
    public void update() throws Exception {
        ...
        when(service.update(any(EventSummary.class), anyLong())).thenReturn(entity1);
...
//    }
    ...
    public void exceptions_delete_NotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(status().isBadRequest())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof EntityNotFoundException))
                .andExpect(result -> assertEquals("EventSummary was not found for parameters {id=2}", result.getResolvedException().getMessage()));
