...
@ComponentScan(basePackageClasses = CategoryMapper.class)
...
public class CategoryControllerTest {
    ...
    CategoryDTO entityDTO1 = new CategoryDTO();
    CategoryDTO entityDTO2 = new CategoryDTO();
...
//        System.out.println("content : ->" + content + "<-");
    ...
    public void getAll() throws Exception {
        ...
        List<Category> entitys = new ArrayList<>(Arrays.asList(entity1, entity2));
...
//    }
    ...
    public void exceptions_delete_NotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(status().isBadRequest())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof EntityNotFoundException))
                .andExpect(result -> assertEquals("Category was not found for parameters {id=2}", result.getResolvedException().getMessage()));
