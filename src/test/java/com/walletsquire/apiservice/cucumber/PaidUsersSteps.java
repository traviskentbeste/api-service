...
public class PaidUsersSteps {
    ...
    private List<PaidUsers> entityList = new ArrayList<>();

    @Given("The paidUser is available at {string} with endpoint {string}")
    ...
    @Then("I should find at least {int} paidUsers")
