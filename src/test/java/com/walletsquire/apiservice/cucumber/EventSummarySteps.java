...
public class EventSummarySteps {
    ...
    private List<EventSummary> entityList = new ArrayList<>();

    @Given("The eventSummary is available at {string} with endpoint {string}")
    ...
    @Then("I should find at least {int} event-summary")
